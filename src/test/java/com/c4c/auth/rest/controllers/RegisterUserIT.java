...
public class RegisterUserIT extends BaseIT {
  ...
  void testFailToRegisterUserCauseInvalidData() {
    HttpEntity<CreateUserDto> request =
        new HttpEntity<>(new CreateUserDto(), testUtility.createHeaders());

    ResponseEntity<InvalidDataResponse> response =
        restTemplate.postForEntity(ENDPOINT, request, InvalidDataResponse.class);
  ...
  public void testRegisterUserSuccess() {
    ...
    HttpEntity<CreateUserDto> request =
        new HttpEntity<>(createUserDto, testUtility.createHeaders());
    ...
    ResponseEntity<User> registerResponse =
        restTemplate.postForEntity(ENDPOINT, request, User.class);
