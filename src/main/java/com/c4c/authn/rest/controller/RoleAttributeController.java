...
import static com.c4c.authn.rest.controller.RoleAttributeController.BASE_URL;
...
public class RoleAttributeController extends BaseController {
     ...
     */
    @GetMapping(value = "/{roleId}/{attributeId}", produces = MediaType.APPLICATION_JSON_VALUE)
     ...
     * @return the response entity
     */
    @DeleteMapping(value = "/{roleId}/{attributeId}", produces = MediaType.APPLICATION_JSON_VALUE)
