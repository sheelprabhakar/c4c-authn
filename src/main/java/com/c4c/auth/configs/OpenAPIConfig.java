...
public class OpenAPIConfig {
  ...
  public OpenAPI myOpenAPI() {
    ...
    contact.setEmail("bimbim.in@gmail.com");
    contact.setName("C4C AuthN");
    contact.setUrl("https://www.code4copy.com");
    ...
    Info info = new Info().title("Tutorial Management API").version("1.0").contact(contact)
        ...
        .termsOfService("https://www.code4copy.com/terms").license(mitLicense);
