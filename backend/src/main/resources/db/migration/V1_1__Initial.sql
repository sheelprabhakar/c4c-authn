...
INSERT INTO `attributes` (`id`, `tenant_id`, `name`, `path`, `is_deleted`, `created_by`, `updated_by`) VALUES ('642efdd3-ac33-4cf9-a187-f43c71a27714', 'fe9f8f3c-6447-4fb1-a9ba-6856bccd3d9b', 'Policy Read', '/v1/api/**/policy/**', '0', 'SYSTEM', 'SYSTEM');
...
INSERT INTO `role_attributes` (`role_id`, `attribute_id`, `can_create`, `can_read`, `can_update`, `can_delete`, `is_deleted`, `created_by`, `updated_by`) VALUES ('52a05765-a8e0-4fd7-b95b-3b14b52634f5', '642efdd3-ac33-4cf9-a187-f43c71a27714', '1', '1', '1', '1', '1', 'SYSTEM', 'SYSTEM');
